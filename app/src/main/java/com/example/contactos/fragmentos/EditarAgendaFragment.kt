 ...
 */
class EditarAgendaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fecha.setText(arguments?.getString("fecha"))
        binding.hora.setText(arguments?.getString("hora"))
        binding.nota.setText(arguments?.getString("notas"))
        binding.guardar.setOnClickListener {
            if (binding.fecha.text.toString().isNotEmpty() && binding.hora.text.toString()
                ...
                val agenda = AgendaModel(arguments?.getString("id"), fecha,hora,nota)
                val save = db.updateDatos(agenda)
